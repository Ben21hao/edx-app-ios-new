...
@implementation TDOrderCommentCell
...
- (void)setDetailItem:(TDTeacherCommentModel *)detailItem {
    ...
    NSString *url = [toolModel dealwithImageStr:[NSString stringWithFormat:@"%@%@",ELITEU_URL,_detailItem.avatar_url]];
